...
function SearchHistory({setFocused}) {
  ...
  return (
    <div className="absolute flex flex-col top-full w-full rounded-md mt-1 bg-slate-100 overflow-auto p-4 h-auto max-sm:max-h-[300px] max-h-[500px] z-20">
      {historyResearches.length === 0 ? (
        <div className="text-center max-sm:text-sm text-gray">
          No search history
        </div>
      ) : (
